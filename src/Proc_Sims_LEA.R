...
final_df$LEA_1.2.0_ALL_K1_log10p <-  -log10(pv1)
final_df$LEA_1.2.0_ALL_K2_log10p <-  -log10(pv2)
final_df$LEA_1.2.0_ALL_K3_log10p <-  -log10(pv3)
final_df$LEA_1.2.0_ALL_K1_z <- z_ave1
final_df$LEA_1.2.0_ALL_K2_z <- z_ave2
final_df$LEA_1.2.0_ALL_K3_z <- z_ave3
