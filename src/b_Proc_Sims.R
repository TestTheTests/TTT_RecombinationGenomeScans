...
# The inversion tracking mutation had these weird genotypes
  # For reasons I don't completely understand, the inversion tracking mutation (m5)
  # had weird output by msprime and pyslim after recapitation and adding neutral mutations.
  # Sometimes it was 0/2 and sometimes 2/3 was output
