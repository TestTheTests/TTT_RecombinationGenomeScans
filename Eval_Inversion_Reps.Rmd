...
plot_layers <- function(y_head=0, y_arrows=c(1,0.25), thisSim=NULL, ...){
  ...
  arrows(muts$pos[muts$descript=="QTL"],  y_arrows[1], muts$pos[muts$descript=="QTL"],  y_arrows[2], col="orange", lwd=muts$prop[muts$descript=="QTL"]*10, length = 0.1)
  }
...
sum(is.na(x_all$simID))
  ...
  print.data.frame(x_all[is.na(x_all$a_freq_final),])
